...
class Formulario_biseccion(forms.Form):
    ...
    xf = forms.FloatField(label='Xi', required=True, widget=forms.NumberInput(attrs={'placeholder':'Ingrese el x final...','step':'0.0001'}))
...
class Formulario_incremental(forms.Form):
    ...
    difx = forms.FloatField(label='difx', required=True, widget=forms.NumberInput(attrs={'placeholder':'Ingrese la diferencia de x...','step':'0.0001'}))
